...
# 2. 批量加载整个数据集
folder_path = "/CardRFDataset/CardRF/LOS/Train/BLUETOOTH/MOTOROLA/split/"  # 你的数据集文件夹路径
expand_num = 85400 - 59780  # 需要生成的数据量
output_folder = "/CardRFDataset/CardRF/LOS/Train/BLUETOOTH/MOTOROLA/split/4_expanded"  # 生成的数据存放目录
...
for i in range(num_chunks):
    ...
    save_path = os.path.join(output_folder, f"4_expanded_part{i}.npz")

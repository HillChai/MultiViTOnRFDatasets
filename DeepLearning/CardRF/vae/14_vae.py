...
# 2. 批量加载整个数据集
folder_path = "/CardRFDataset/CardRF/LOS/Train/UAV_Controller/BEEBEERUN/split/"  # 你的数据集文件夹路径
expand_num = 85400 - 59780  # 需要生成的数据量
current = 14
output_folder = f"/CardRFDataset/CardRF/LOS/Train/UAV_Controller/BEEBEERUN/split/{current}_expanded"  # 生成的数据存放目录

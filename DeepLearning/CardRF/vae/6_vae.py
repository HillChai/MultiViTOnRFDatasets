...
# 2. 批量加载整个数据集
folder_path = "/CardRFDataset/CardRF/LOS/Train/UAV/DJI_INSPIRE/FLYING/split/"  # 你的数据集文件夹路径
expand_num = 85400 - 42700  # 需要生成的数据量
current = 6
output_folder = f"/CardRFDataset/CardRF/LOS/Train/UAV/DJI_INSPIRE/FLYING/split/{current}_expanded"  # 生成的数据存放目录
